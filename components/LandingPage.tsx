      ...
      <div className="relative overflow-hidden bg-gradient-to-br from-blue-50 via-green-50 to-cyan-50 dark:from-gray-900 dark:via-gray-800 dark:to-blue-900">
        ...
        <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12 sm:py-16 md:py-20">
          <div className="text-center">
            {/* Badge */}
            <div className="inline-flex items-center gap-2 px-3 py-1.5 sm:px-4 sm:py-2 rounded-full bg-gradient-to-r from-blue-100 to-green-100 dark:from-blue-900/30 dark:to-green-900/30 text-blue-600 dark:text-blue-400 mb-6 sm:mb-8">
            ...
            <div className="flex flex-col sm:flex-row items-center justify-center gap-3 sm:gap-4 mb-12 sm:mb-16 px-4">
              <Link href={userId ? "/dashboard/analytics" : "/sign-up"} className="w-full sm:w-auto">
                <Button size="lg" className="w-full sm:w-auto bg-gradient-to-r from-blue-600 via-green-600 to-cyan-600 hover:from-blue-700 hover:via-green-700 hover:to-cyan-700 text-white px-6 sm:px-8 py-5 sm:py-6 text-base sm:text-lg shadow-lg shadow-blue-500/50">
                  {userId ? "Go to Dashboard" : "Start Creating Free"}
                  <ArrowRight className="ml-2 w-4 h-4 sm:w-5 sm:h-5" />
                </Button>
              </Link>
              <Link href="/dashboard/forms" className="w-full sm:w-auto">
                <Button size="lg" variant="outline" className="w-full sm:w-auto px-6 sm:px-8 py-5 sm:py-6 text-base sm:text-lg border-blue-600 text-blue-600 hover:bg-blue-50 dark:hover:bg-blue-900/20">
        ...
        <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12 sm:py-16 md:py-20">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 sm:gap-8 mb-12 sm:mb-16 md:mb-20">
            ...
            {/* Feature 4 */}
            <div className="p-6 sm:p-8 bg-white/60 dark:bg-gray-800/60 backdrop-blur-sm rounded-2xl border border-white/20 dark:border-gray-700/20 hover:shadow-xl hover:shadow-teal-500/10 transition-all duration-300">
          ...
          <div className="mb-12 sm:mb-16 md:mb-20">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8 sm:gap-10 text-center">
              ...
              <div className="flex flex-col items-center px-4">
                <div className="w-16 h-16 sm:w-20 sm:h-20 bg-gradient-to-r from-blue-100 to-green-100 dark:from-blue-900/30 dark:to-green-900/30 rounded-full flex items-center justify-center mb-4">
              ...
              {/* Step 2 */}
              <div className="flex flex-col items-center px-4">
                <div className="w-16 h-16 sm:w-20 sm:h-20 bg-gradient-to-r from-green-100 to-cyan-100 dark:from-green-900/30 dark:to-cyan-900/30 rounded-full flex items-center justify-center mb-4">
              ...
              {/* Step 3 */}
              <div className="flex flex-col items-center px-4">
                <div className="w-16 h-16 sm:w-20 sm:h-20 bg-gradient-to-r from-cyan-100 to-blue-100 dark:from-cyan-900/30 dark:to-blue-900/30 rounded-full flex items-center justify-center mb-4">
                  <Share2 className="w-8 h-8 sm:w-10 sm:h-10 text-cyan-600 dark:text-cyan-400" />
                </div>
          ...
          {/* Stats Section */}
          <div className="bg-gradient-to-r from-blue-600 via-green-600 to-cyan-600 rounded-2xl sm:rounded-3xl p-6 sm:p-10 md:p-12 mb-12 sm:mb-16 md:mb-20">
            <div className="grid grid-cols-2 md:grid-cols-4 gap-6 sm:gap-8 text-center text-white">
              <div>
                ...
                <div className="text-xs sm:text-sm md:text-base text-blue-100">Forms Created</div>
              </div>
              <div>
                <div className="text-3xl sm:text-4xl md:text-5xl font-bold mb-1 sm:mb-2">500+</div>
                <div className="text-xs sm:text-sm md:text-base text-green-100">Happy Users</div>
              </div>
              <div>
                <div className="text-3xl sm:text-4xl md:text-5xl font-bold mb-1 sm:mb-2">99.9%</div>
                <div className="text-xs sm:text-sm md:text-base text-cyan-100">Uptime</div>
              </div>
              <div>
                <div className="text-3xl sm:text-4xl md:text-5xl font-bold mb-1 sm:mb-2">Max</div>
                <div className="text-xs sm:text-sm md:text-base text-blue-100">Support</div>
              </div>
            </div>
          </div>
        ...
        {/* CTA Section */}
        <div className="relative z-10 max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-12 sm:py-16 md:py-20">
          <div className="bg-gradient-to-r from-blue-600 via-green-600 to-cyan-600 rounded-2xl sm:rounded-3xl p-6 sm:p-10 md:p-12 text-center shadow-2xl shadow-blue-500/20">
            ...
            <Link href="/sign-up" className="inline-block w-full sm:w-auto">
              <Button size="lg" className="w-full sm:w-auto bg-white text-blue-600 hover:bg-gray-100 px-6 sm:px-8 py-5 sm:py-6 text-sm sm:text-base md:text-lg font-semibold shadow-xl">
